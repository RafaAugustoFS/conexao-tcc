      ...
      <div className="flex min-h-screen bg-[#F0F7FF] dark:bg-[#141414]">
        ...
        <main className="flex-1 p-8">
          ...
          <div className="container mx-auto p-6 space-y-6 max-w-5xl bg-white dark:bg-gray-800 rounded-3xl">
            <Image
              src={imageUrl || "https://img.freepik.com/free-vector/isolated-young-handsome-man-different-poses-white-background-illustration_632498-855.jpg"}
              alt="Profile"
              width={80}
              height={80}
          ...
          <ModalCreate isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} message="Editando aluno..." />
        </main>
      </div>
    </>
  );
