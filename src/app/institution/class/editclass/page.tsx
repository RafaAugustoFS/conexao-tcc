...
import { SelectEdit, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/institution/select"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-4">
          <div>
            ...
            <Input defaultValue="Ds-Libbs" className="bg-blue-50" />
          </div>

          <div>
            <label className="text-sm text-muted-foreground">Período</label>
            <SelectEdit defaultValue="Manha">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Input defaultValue={40} type="number" className="bg-blue-50" />
            </div>
            <div>
              <label className="text-sm text-muted-foreground">N° da sala</label>
              <Input defaultValue={15} type="number" className="bg-blue-50" />
            </div>
          </div>
        </div>
      </div>
